...
class Cover5 extends Component {
  constructor() {
    super();
    this.state = {
    ...
    return (
      <div className="container2 white">
        <div className="box2 "   >
          ...
          <div className="centerAll"   >
            <div className="marginT "   >
              <hr className="lineSplit5" />
              <div className="staName "   >STATION 22</div>
              <hr className="lineSplit5" />
              ...
              <div className="containerTextVideo">
                ...
                <div>
                  ...
                  {this.state.jcp2 &&
                    <div>
                      <div className="titre stacolor"  >Palliser


                      </div>
                      <div className="texte stacolor"  >Montage vidéo à partir d’images fixes (photos) fournies par le client. Pour donner un peu plus de qualité, nous avons ajouté de l’animation/effets dans certaines images pour rendre le tout plus dynamique.
                      </div>
                    </div>}
                  ...
                  {this.state.jcp3 && <div>
                    <div className="titre stacolor"  >Natuzzi (Remontage 30s)


                    </div>
                    <div className="texte stacolor "  >Nous avons été mandaté de produire une publicité 30s à partir d’une vidéo existante de 55 secondes. Nous avons dû recréer une histoire à partir d’images existantes et créer une ambiance qui fait rêver avec des effets sonores.
                    </div>
                  </div>}
        ...
        <div id="" className="footer2" >
          ...
          <div id="" className="client2" ></div>
          <div id="" className="client2" ></div>
          <div id="" className="clientONsta" ></div>
        </div>
